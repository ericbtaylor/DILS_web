...
tmp += "pypy {6}/priorgen_1pop.py {0} {1} {2} | {6}/msnsam tbs {3} {4} | pypy {6}/mscalc_1pop_SFS.py {5}".format(model, nmultilocus, config_yaml, nmultilocus*nlocus, mscommand, outgroup, binpath)
print(tmp)
