...
if mscommand == "":
	...
	tmp_migration += "pypy {0}/priorgen_gof_2pop_test_monolocus.py {1} {2} {3} {4} migration {5} | {0}/msnsam tbs {6} {7} >tmp.ms ;".format(binpath, model, nmultilocus, posterior_file, modeBarrier, population_growth, nmultilocus*nlocus, mscommand, outgroup)
	...
	tmp_isolation += "pypy {0}/priorgen_gof_2pop_test_monolocus.py {1} {2} {3} {4} isolation {5} | {0}/msnsam tbs {6} {7} >tmp.ms ;".format(binpath, model, nmultilocus, posterior_file, modeBarrier, population_growth, nmultilocus*nlocus, mscommand, outgroup)
